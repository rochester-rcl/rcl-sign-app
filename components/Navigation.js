...
export default class Navigation extends Component {
  ...
  render() {
    ...
    const { searchResults, language, portraitKeyboardActive, layoutAspect } = this.props;
    ...
    return(
      <View style={layoutAspect === 'LAYOUT_LANDSCAPE' ? NavigationStyles.navContainerLandscape : NavigationStyles.navContainer}>
        <TextInput
          style={(searchFocused && portraitKeyboardActive) ? NavigationStyles.searchBarFocused : NavigationStyles.searchBar}
        ...
        />
        <View style={(searchFocused && portraitKeyboardActive) ? NavigationStyles.hideNav : NavigationStyles.letterPicker}>
          <Modal
            animationType={"fade"}
            transparent={false}
        ...
        <View style={(searchFocused && portraitKeyboardActive) ? NavigationStyles.hideNav : NavigationStyles.letterRange}>
